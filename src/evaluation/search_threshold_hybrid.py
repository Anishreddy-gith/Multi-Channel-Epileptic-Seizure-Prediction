...
def main():
    ...
    out_csv = experiment_path("results/threshold_search_hybrid.csv")
    threshold_path = experiment_path("results/hybrid_best_threshold.txt")
